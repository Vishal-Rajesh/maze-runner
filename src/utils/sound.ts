// Web Audio API synthesizer for crisp arcade sounds
...
class SoundManager {
  ...
  // Fruit Ninja letter slice sound
  playSlice() {
  ...
  // Checkpoint reached fanfare / chime
